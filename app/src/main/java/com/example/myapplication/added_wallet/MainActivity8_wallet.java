...
import com.example.myapplication.databinding.ActivityMain8WalletAddedBinding;

import java.io.ByteArrayOutputStream;

public class MainActivity8_wallet extends AppCompatActivity implements SensorEventListener {


    private ActivityMain8WalletAddedBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMain8WalletAddedBinding.inflate(getLayoutInflater());
