...
import com.example.myapplication.databinding.ActivityMain4WalletAddedBinding;

import java.io.ByteArrayOutputStream;

public class MainActivity4_wallet extends AppCompatActivity implements SensorEventListener{


    private ActivityMain4WalletAddedBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMain4WalletAddedBinding.inflate(getLayoutInflater());
