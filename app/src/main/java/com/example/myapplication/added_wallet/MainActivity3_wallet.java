...
import com.example.myapplication.databinding.ActivityMain3WalletAddedBinding;

import java.io.ByteArrayOutputStream;

public class MainActivity3_wallet extends AppCompatActivity implements SensorEventListener {


    private ActivityMain3WalletAddedBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMain3WalletAddedBinding.inflate(getLayoutInflater());
